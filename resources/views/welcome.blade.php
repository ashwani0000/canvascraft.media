        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-info ">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" style="font-size: 2rem; color: #f7fafc; margin-right:20px; border: 2px solid white; padding:10px">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" style="font-size: 2rem; color: #f7fafc; margin-right:20px; border: 2px solid white; padding:10px">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div>
                <h2 style="color: beige;font-size:3rem;">Employee Management Web Application</h2>
            </div>
        </div>
